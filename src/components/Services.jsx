    ...
    <section id="services" className="py-24 bg-white">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          ...
          >
            <h2 className="text-base font-semibold leading-7 text-brand-brown-600">Services</h2>
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
            {services.map((service, index) => (
              <motion.div
                ...
                className="group relative bg-white rounded-2xl border border-gray-200 p-8 shadow-sm hover:shadow-lg transition-all duration-300 hover:border-brand-brown-200"
              >
                {/* Background decoration */}
                <div className="absolute top-4 right-4 opacity-10 group-hover:opacity-20 transition-opacity">
                  <service.icon className="h-16 w-16 text-brand-brown-600" />
                </div>
                ...
                <div className="relative">
                  ...
                  <div className="flex items-start space-x-4 mb-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-xl font-semibold text-gray-900 group-hover:text-brand-brown-600 transition-colors">
                        {service.title}
                      </h3>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    {service.features.map((feature, featureIndex) => (
                      <div key={featureIndex} className="flex items-center space-x-2">
                        <SparklesIcon className="h-4 w-4 text-brand-brown-500 flex-shrink-0" />
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-brand-brown-50/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity rounded-2xl pointer-events-none"></div>
                </div>
              </motion.div>
            ))}
          </div>
        ...
        >
          <div className="bg-brand-brown-50 rounded-2xl p-8 border border-brand-brown-100">
            <PuzzlePieceIcon className="h-12 w-12 text-brand-brown-600 mx-auto mb-4" />
            ...
            <button
              ...
              className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-brand-brown-600 hover:bg-brand-brown-700 transition-colors duration-200 hover:scale-105 transform"
            >
              Start Your Project
